...
const Banner = () => {
  ...
  <div className='text-white'>
    <h2 className='text-3xl font-medium'>
        Take the car and ride your journey
    </h2>
        <p className='mt-2'>Monetize your vehicle effortlessly by listing it on CarRental.
...
We take care of insurance, driver verification and secure payments — so you can earn passive income, stress-free.</p>
  ...
  <img src={assets.banner_car_image} className='max-h-45 mt-10'></img>
